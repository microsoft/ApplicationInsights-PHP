...
class Envelope implements \JsonSerializable {
    ...
    public function getFlags() {
        if (array_key_exists('flags', $this->_data)) {
    ...
    public function getDeviceId() {
        if (array_key_exists('deviceId', $this->_data)) {
    ...
    public function getOs() {
        if (array_key_exists('os', $this->_data)) {
    ...
    public function getOsVer() {
        if (array_key_exists('osVer', $this->_data)) {
    ...
    public function getAppId() {
        if (array_key_exists('appId', $this->_data)) {
    ...
    public function getAppVer() {
        if (array_key_exists('appVer', $this->_data)) {
    ...
    public function getUserId() {
        if (array_key_exists('userId', $this->_data)) {
